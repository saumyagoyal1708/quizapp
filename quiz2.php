...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 1";
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 2";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 3";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 4";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 5";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 6";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 7";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 8";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 9";
$answer = mysqli_query($conn, $sql);
...
$sql = " SELECT answer,SlNo  FROM s4  WHERE SlNo like 10";
$answer = mysqli_query($conn, $sql);
...
$email = $_SESSION["email" ];
 $sql = " SELECT  name, email_id , sports FROM s8  ";
...
if($f==1)
{
  if($row['sports'] < $count)
  {
  $sql = "UPDATE s8 SET sports = '$count' WHERE  email_id = '$email' ";
}
else
{
   echo "<br>";
