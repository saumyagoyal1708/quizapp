...
else 
{
  ...
  echo "<br><br>";
  echo '<center> <a href="form1.html"><button class = "click" type="submit"> login again </button></a></center>';
 ...
 echo "<br>";
 echo '<center> <a href="form1.html"><button class = "click1" type="submit"> logout </button></a></center>';
